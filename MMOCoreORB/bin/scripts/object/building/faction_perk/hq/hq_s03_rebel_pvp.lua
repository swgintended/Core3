...
object_building_faction_perk_hq_hq_s03_rebel_pvp = object_building_faction_perk_hq_shared_hq_s03_rebel_pvp:new {
		...
		childObjects = {
			...
			{ templateFile = "object/installation/faction_perk/minefield/field_1x1.iff", x = 0, z = 0, y = 34, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1 },
			
			{ templateFile = "object/installation/faction_perk/covert_detector/detector_base.iff", x = 0, z = 0, y = 44, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1 },
